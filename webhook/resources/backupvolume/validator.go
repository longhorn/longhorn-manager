...
func (bv *backupVolumeValidator) Create(request *admission.Request, newObj runtime.Object) error {
	backupVolume := newObj.(*longhorn.BackupVolume)

	if err := checkEmptyBackupTargetVolumeName(backupVolume); err != nil {
...
func checkEmptyBackupTargetVolumeName(backupVolume *longhorn.BackupVolume) error {
