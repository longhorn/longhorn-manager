...
func mutate(newObj runtime.Object) (admission.PatchOps, error) {
	...
	if diskSchedule.Spec.SchedulingReplicas == nil {
		patchOps = append(patchOps, `{"op": "replace", "path": "/spec/schedulingReplicas", "value": {}}`)
	}

	if diskSchedule.Spec.SchedulingBackingImages == nil {
		patchOps = append(patchOps, `{"op": "replace", "path": "/spec/schedulingBackingImages", "value": {}}`)
	}
