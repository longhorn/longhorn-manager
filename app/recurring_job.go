...
import (
	...
	controllerevent "github.com/longhorn/longhorn-manager/controller"
...
func (job *Job) doSnapshotCleanup(backupDone bool) (err error) {
	defer func() {
		if err != nil {
			...
			if err := job.eventCreate(corev1.EventTypeWarning, controllerevent.EventReasonFailedDeleting, errMessage); err != nil {
