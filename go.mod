...
require (
	...
	github.com/longhorn/longhorn-instance-manager v1.7.0-dev.0.20240628012109-4dd756e9c266
	github.com/longhorn/longhorn-share-manager v1.7.0-dev.0.20240625052332-1f69285a5801
