...
require (
	...
	github.com/longhorn/longhorn-instance-manager v1.7.0-dev.0.20240523160748-a4b542f30cb7
	github.com/longhorn/longhorn-share-manager v1.7.0-dev.0.20240518040159-dc8535e54ff9
