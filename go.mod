...
require (
	...
	github.com/longhorn/backing-image-manager v1.8.0-rc3
	...
	github.com/longhorn/longhorn-instance-manager v1.8.0-rc3
	github.com/longhorn/longhorn-share-manager v1.8.0-rc3
