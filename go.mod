...
replace (
	github.com/longhorn/longhorn-share-manager => /home/jmoody/go/src/github.com/longhorn/longhorn-share-manager
...
require (
	...
	github.com/longhorn/longhorn-share-manager v0.0.0-00010101000000-000000000000
