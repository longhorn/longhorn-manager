...
require (
	...
	github.com/longhorn/longhorn-instance-manager v1.7.0-dev.0.20240328050839-24423777575d
...
require (
	...
	github.com/longhorn/longhorn-spdk-engine v0.0.0-20240326225129-c0ac4cbe90cb // indirect
