...
var (
	...
	SettingDefinitionV2DataEngineSnapshotDataIntegrity = SettingDefinition{
		...
		Description: "This setting allows users to enable or disable snapshot hashing and data integrity checking for v2 data engine. \n\n" +
			...
			"- **fast-check**: Enable snapshot logical volume data hashing and fast data integrity checking. Longhorn system only hashes snapshot if their are not hashed. In this mode, filesystem-unaware corruption cannot be detected, but the impact on system performance can be minimized.",
		Category: SettingCategoryV2DataEngine,
		Type:     SettingTypeString,
		Required: true,
		ReadOnly: false,
