...
var (
	...
	SettingDefinitionOfflineReplicaRebuilding = SettingDefinition{
		...
		Description: "Enables automatic rebuilding of degraded replicas while the volume is detached. This setting only takes effect if the individual volume setting is set to `ignored`. \n\n" +
			"Available options: \n\n" +
