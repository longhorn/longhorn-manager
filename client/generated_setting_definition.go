...
type SettingDefinition struct {
	...
	ApplicableEngines map[string]string `json:"applicableEngines,omitempty" yaml:"applicable_engines,omitempty"`

	Category string `json:"category,omitempty" yaml:"category,omitempty"`

	Default string `json:"default,omitempty" yaml:"default,omitempty"`

	DefaultsByEngine map[string]string `json:"defaultsByEngine,omitempty" yaml:"defaults_by_engine,omitempty"`
