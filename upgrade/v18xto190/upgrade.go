...
const upgradeLogPrefix = "upgrade from v1.9.0 to v1.9.1: "
...
func updateOrphanResourceAutoDeletionSetting(settingsMap map[string]*v1beta2.Setting) (err error) {
	...
	resourceTypes, _ := types.UnmarshalOrphanResourceTypes(newSetting.Value)
