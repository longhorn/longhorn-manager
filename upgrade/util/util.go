...
func CheckUpgradePath(namespace string, lhClient lhclientset.Interface, kubeClient clientset.Interface, eventRecorder record.EventRecorder, enableUpgradeVersionCheck bool, requestedControlPath string) error {
