...
APIS_DIR="github.com/longhorn/longhorn-manager/upgrade/v1alpha1/k8s/pkg/apis/longhorn"
VERSION="v1alpha1"
APIS_VERSION_DIR="${APIS_DIR}/${VERSION}"
OUTPUT_DIR="github.com/longhorn/longhorn-manager/upgrade/v1alpha1/k8s/pkg/client"
