...
import (
	v1alpha1 "github.com/longhorn/longhorn-manager/upgrade/v1alpha1/k8s/pkg/client/clientset/versioned/typed/longhorn/v1alpha1"
...
func (c *FakeLonghornV1alpha1) EngineImages(namespace string) v1alpha1.EngineImageInterface {
	return &FakeEngineImages{c, namespace}
}

func (c *FakeLonghornV1alpha1) InstanceManagers(namespace string) v1alpha1.InstanceManagerInterface {
