...
var instancemanagersResource = schema.GroupVersionResource{Group: "longhorn.rancher.io", Version: "v1alpha1", Resource: "instancemanagers"}
...
func (c *FakeInstanceManagers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceManagerList, err error) {
	...
	list := &v1alpha1.InstanceManagerList{ListMeta: obj.(*v1alpha1.InstanceManagerList).ListMeta}
	for _, item := range obj.(*v1alpha1.InstanceManagerList).Items {
