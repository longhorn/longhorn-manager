	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1alpha1().Nodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1alpha1().Nodes(namespace).Watch(context.TODO(), options)
			},
		},
		&longhornv1alpha1.Node{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhornv1alpha1.Node{}, f.defaultInformer)
}
