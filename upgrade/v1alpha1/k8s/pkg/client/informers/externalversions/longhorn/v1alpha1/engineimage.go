	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1alpha1().EngineImages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1alpha1().EngineImages(namespace).Watch(context.TODO(), options)
			},
		},
		&longhornv1alpha1.EngineImage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *engineImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhornv1alpha1.EngineImage{}, f.defaultInformer)
}

func (f *engineImageInformer) Lister() v1alpha1.EngineImageLister {
	return v1alpha1.NewEngineImageLister(f.Informer().GetIndexer())
}
