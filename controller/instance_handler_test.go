...
func (imh *MockInstanceManagerHandler) SwitchOverTargetInstance(obj interface{}, targetInstanceAddress string) error {
	return fmt.Errorf("SwitchOverTargetInstance is not mocked")
}
