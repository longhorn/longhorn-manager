...
func (sc *SettingController) updateTaintToleration() error {
	...
	updatingRuntimeObjects := []runtime.Object{}
	...
	for _, ds := range daemonsetList {
		updatingRuntimeObjects = append(updatingRuntimeObjects, runtime.Object(ds))
	}
	...
	for _, dp := range deploymentList {
		updatingRuntimeObjects = append(updatingRuntimeObjects, runtime.Object(dp))
	}
	...
	for _, pod := range pods {
		updatingRuntimeObjects = append(updatingRuntimeObjects, runtime.Object(pod))
	}
