...
func NewWebsocketController(
	...
	ds.ObjectEndpointInformer.AddEventHandler(wc.notifyWatchersHandler("objectEndpoint"))
	wc.cacheSyncs = append(wc.cacheSyncs, ds.ObjectEndpointInformer.HasSynced)
