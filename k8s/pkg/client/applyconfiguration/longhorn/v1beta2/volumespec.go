...
// WithReplicaRebuildBandwidthLimit sets the ReplicaRebuildBandwidthLimit field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ReplicaRebuildBandwidthLimit field is set to the value of the last call.
func (b *VolumeSpecApplyConfiguration) WithReplicaRebuildBandwidthLimit(value int64) *VolumeSpecApplyConfiguration {
	b.ReplicaRebuildBandwidthLimit = &value
	return b
}
