...
type V2DataEngineStatusApplyConfiguration struct {
	...
	InterruptModeEnabled *bool   `json:"interruptModeEnabled,omitempty"`
}
...
func (b *V2DataEngineStatusApplyConfiguration) WithInterruptModeEnabled(value bool) *V2DataEngineStatusApplyConfiguration {
