...
type BackupSpecApplyConfiguration struct {
	...
	BackupBlockSize *longhornv1beta2.BackupBlockSize `json:"backupBlockSize,omitempty"`
}
...
func (b *BackupSpecApplyConfiguration) WithBackupBlockSize(value longhornv1beta2.BackupBlockSize) *BackupSpecApplyConfiguration {
