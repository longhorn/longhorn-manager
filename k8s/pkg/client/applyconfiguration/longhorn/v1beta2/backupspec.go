...
type BackupSpecApplyConfiguration struct {
	...
	BackupBlockSize *string                     `json:"backupBlockSize,omitempty"`
}
...
func (b *BackupSpecApplyConfiguration) WithBackupBlockSize(value string) *BackupSpecApplyConfiguration {
