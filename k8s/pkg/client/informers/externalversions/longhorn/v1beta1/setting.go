...
type SettingInformer interface {
	...
	Lister() longhornv1beta1.SettingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().Settings(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Settings(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Settings(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Settings(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.Setting{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *settingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.Setting{}, f.defaultInformer)
}

func (f *settingInformer) Lister() longhornv1beta1.SettingLister {
	return longhornv1beta1.NewSettingLister(f.Informer().GetIndexer())
}
