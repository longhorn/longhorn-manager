...
type BackupVolumeInformer interface {
	...
	Lister() longhornv1beta1.BackupVolumeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().BackupVolumes(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupVolumes(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupVolumes(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupVolumes(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.BackupVolume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupVolumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.BackupVolume{}, f.defaultInformer)
}

func (f *backupVolumeInformer) Lister() longhornv1beta1.BackupVolumeLister {
	return longhornv1beta1.NewBackupVolumeLister(f.Informer().GetIndexer())
}
