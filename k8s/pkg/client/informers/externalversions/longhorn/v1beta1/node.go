...
type NodeInformer interface {
	...
	Lister() longhornv1beta1.NodeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().Nodes(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Nodes(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Nodes(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().Nodes(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.Node{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.Node{}, f.defaultInformer)
}

func (f *nodeInformer) Lister() longhornv1beta1.NodeLister {
	return longhornv1beta1.NewNodeLister(f.Informer().GetIndexer())
}
