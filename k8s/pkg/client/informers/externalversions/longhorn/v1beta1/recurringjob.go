...
type RecurringJobInformer interface {
	...
	Lister() longhornv1beta1.RecurringJobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().RecurringJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().RecurringJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().RecurringJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().RecurringJobs(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.RecurringJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recurringJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.RecurringJob{}, f.defaultInformer)
}

func (f *recurringJobInformer) Lister() longhornv1beta1.RecurringJobLister {
	return longhornv1beta1.NewRecurringJobLister(f.Informer().GetIndexer())
}
