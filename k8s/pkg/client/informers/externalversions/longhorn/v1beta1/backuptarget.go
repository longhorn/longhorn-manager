...
type BackupTargetInformer interface {
	...
	Lister() longhornv1beta1.BackupTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().BackupTargets(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupTargets(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupTargets(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackupTargets(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.BackupTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.BackupTarget{}, f.defaultInformer)
}

func (f *backupTargetInformer) Lister() longhornv1beta1.BackupTargetLister {
	return longhornv1beta1.NewBackupTargetLister(f.Informer().GetIndexer())
}
