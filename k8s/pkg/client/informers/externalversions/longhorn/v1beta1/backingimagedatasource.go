...
type BackingImageDataSourceInformer interface {
	...
	Lister() longhornv1beta1.BackingImageDataSourceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().BackingImageDataSources(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackingImageDataSources(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackingImageDataSources(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().BackingImageDataSources(namespace).Watch(ctx, options)
			},
		},
		&apislonghornv1beta1.BackingImageDataSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backingImageDataSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apislonghornv1beta1.BackingImageDataSource{}, f.defaultInformer)
}

func (f *backingImageDataSourceInformer) Lister() longhornv1beta1.BackingImageDataSourceLister {
	return longhornv1beta1.NewBackingImageDataSourceLister(f.Informer().GetIndexer())
}
