	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.LonghornV1alpha1().Volumes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.LonghornV1alpha1().Volumes(namespace).Watch(options)
			},
		},
		&longhorn_v1alpha1.Volume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhorn_v1alpha1.Volume{}, defaultVolumeInformer)
}
