	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.LonghornV1alpha1().Nodes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.LonghornV1alpha1().Nodes(namespace).Watch(options)
			},
		},
		&longhorn_v1alpha1.Node{},
		resyncPeriod,
		indexers,
	)
}

func defaultNodeInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhorn_v1alpha1.Node{}, defaultNodeInformer)
}
