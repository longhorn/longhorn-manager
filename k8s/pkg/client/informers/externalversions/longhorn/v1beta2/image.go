	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta2().Images(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta2().Images(namespace).Watch(context.TODO(), options)
			},
		},
		&longhornv1beta2.Image{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhornv1beta2.Image{}, f.defaultInformer)
}

func (f *imageInformer) Lister() v1beta2.ImageLister {
	return v1beta2.NewImageLister(f.Informer().GetIndexer())
}
