...
func (c *FakeBackingImageDataSources) Get(name string, options v1.GetOptions) (result *v1beta1.BackingImageDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImageDataSources) List(opts v1.ListOptions) (result *v1beta1.BackingImageDataSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImageDataSources) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeBackingImageDataSources) Create(backingImageDataSource *v1beta1.BackingImageDataSource) (result *v1beta1.BackingImageDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImageDataSources) Update(backingImageDataSource *v1beta1.BackingImageDataSource) (result *v1beta1.BackingImageDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImageDataSources) UpdateStatus(backingImageDataSource *v1beta1.BackingImageDataSource) (*v1beta1.BackingImageDataSource, error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImageDataSources) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeBackingImageDataSources) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(backingimagedatasourcesResource, c.ns, listOptions)
...
func (c *FakeBackingImageDataSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.BackingImageDataSource, err error) {
	obj, err := c.Fake.
