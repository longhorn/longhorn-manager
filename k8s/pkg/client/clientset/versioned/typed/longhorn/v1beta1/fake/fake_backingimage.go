...
func (c *FakeBackingImages) Get(name string, options v1.GetOptions) (result *v1beta1.BackingImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImages) List(opts v1.ListOptions) (result *v1beta1.BackingImageList, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImages) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeBackingImages) Create(backingImage *v1beta1.BackingImage) (result *v1beta1.BackingImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImages) Update(backingImage *v1beta1.BackingImage) (result *v1beta1.BackingImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImages) UpdateStatus(backingImage *v1beta1.BackingImage) (*v1beta1.BackingImage, error) {
	obj, err := c.Fake.
...
func (c *FakeBackingImages) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeBackingImages) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(backingimagesResource, c.ns, listOptions)
...
func (c *FakeBackingImages) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.BackingImage, err error) {
	obj, err := c.Fake.
