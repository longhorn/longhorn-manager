...
type ReplicaInterface interface {
	...
	Get(name string, options v1.GetOptions) (*v1beta1.Replica, error)
	List(opts v1.ListOptions) (*v1beta1.ReplicaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Replica, err error)
	ReplicaExpansion
}
...
func (c *replicas) Get(name string, options v1.GetOptions) (result *v1beta1.Replica, err error) {
...
func (c *replicas) List(opts v1.ListOptions) (result *v1beta1.ReplicaList, err error) {
...
func (c *replicas) Create(replica *v1beta1.Replica) (result *v1beta1.Replica, err error) {
	result = &v1beta1.Replica{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("replicas").
...
func (c *replicas) Update(replica *v1beta1.Replica) (result *v1beta1.Replica, err error) {
	result = &v1beta1.Replica{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("replicas").
...
func (c *replicas) UpdateStatus(replica *v1beta1.Replica) (result *v1beta1.Replica, err error) {
	result = &v1beta1.Replica{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("replicas").
...
func (c *replicas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Replica, err error) {
	result = &v1beta1.Replica{}
