...
type DiskInterface interface {
	Create(*v1beta1.Disk) (*v1beta1.Disk, error)
	Update(*v1beta1.Disk) (*v1beta1.Disk, error)
	UpdateStatus(*v1beta1.Disk) (*v1beta1.Disk, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Disk, error)
	List(opts v1.ListOptions) (*v1beta1.DiskList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Disk, err error)
	DiskExpansion
}
...
func newDisks(c *LonghornV1beta1Client, namespace string) *disks {
	return &disks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *disks) Get(name string, options v1.GetOptions) (result *v1beta1.Disk, err error) {
	result = &v1beta1.Disk{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("disks").
...
func (c *disks) List(opts v1.ListOptions) (result *v1beta1.DiskList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DiskList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("disks").
...
func (c *disks) Create(disk *v1beta1.Disk) (result *v1beta1.Disk, err error) {
	result = &v1beta1.Disk{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("disks").
...
func (c *disks) Update(disk *v1beta1.Disk) (result *v1beta1.Disk, err error) {
	result = &v1beta1.Disk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("disks").
...
func (c *disks) UpdateStatus(disk *v1beta1.Disk) (result *v1beta1.Disk, err error) {
	result = &v1beta1.Disk{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("disks").
...
func (c *disks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Disk, err error) {
	result = &v1beta1.Disk{}
