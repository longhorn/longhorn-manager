...
func (c *FakeShareManagers) Get(name string, options v1.GetOptions) (result *v1beta1.ShareManager, err error) {
	obj, err := c.Fake.
...
func (c *FakeShareManagers) List(opts v1.ListOptions) (result *v1beta1.ShareManagerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeShareManagers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeShareManagers) Create(shareManager *v1beta1.ShareManager) (result *v1beta1.ShareManager, err error) {
	obj, err := c.Fake.
...
func (c *FakeShareManagers) Update(shareManager *v1beta1.ShareManager) (result *v1beta1.ShareManager, err error) {
	obj, err := c.Fake.
...
func (c *FakeShareManagers) UpdateStatus(shareManager *v1beta1.ShareManager) (*v1beta1.ShareManager, error) {
	obj, err := c.Fake.
...
func (c *FakeShareManagers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeShareManagers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sharemanagersResource, c.ns, listOptions)
...
func (c *FakeShareManagers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ShareManager, err error) {
	obj, err := c.Fake.
