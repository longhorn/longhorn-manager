...
var supportbundlesResource = schema.GroupVersionResource{Group: "longhorn.io", Version: "v1beta1", Resource: "supportbundles"}

var supportbundlesKind = schema.GroupVersionKind{Group: "longhorn.io", Version: "v1beta1", Kind: "SupportBundle"}
...
func (c *FakeSupportBundles) List(opts v1.ListOptions) (result *v1beta1.SupportBundleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSupportBundles) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSupportBundles) Update(supportBundle *v1beta1.SupportBundle) (result *v1beta1.SupportBundle, err error) {
	obj, err := c.Fake.
...
func (c *FakeSupportBundles) UpdateStatus(supportBundle *v1beta1.SupportBundle) (*v1beta1.SupportBundle, error) {
	obj, err := c.Fake.
...
func (c *FakeSupportBundles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(supportbundlesResource, c.ns, listOptions)
...
func (c *FakeSupportBundles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SupportBundle, err error) {
	obj, err := c.Fake.
