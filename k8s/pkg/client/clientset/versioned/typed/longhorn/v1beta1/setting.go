...
type SettingInterface interface {
	...
	Get(name string, options v1.GetOptions) (*v1beta1.Setting, error)
	List(opts v1.ListOptions) (*v1beta1.SettingList, error)
...
func (c *settings) Get(name string, options v1.GetOptions) (result *v1beta1.Setting, err error) {
...
func (c *settings) List(opts v1.ListOptions) (result *v1beta1.SettingList, err error) {
...
func (c *settings) Create(setting *v1beta1.Setting) (result *v1beta1.Setting, err error) {
	result = &v1beta1.Setting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("settings").
...
func (c *settings) Update(setting *v1beta1.Setting) (result *v1beta1.Setting, err error) {
	result = &v1beta1.Setting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("settings").
...
func (c *settings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Setting, err error) {
	result = &v1beta1.Setting{}
