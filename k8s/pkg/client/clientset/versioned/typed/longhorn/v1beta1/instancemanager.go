...
type InstanceManagerInterface interface {
	Create(*v1beta1.InstanceManager) (*v1beta1.InstanceManager, error)
	Update(*v1beta1.InstanceManager) (*v1beta1.InstanceManager, error)
	UpdateStatus(*v1beta1.InstanceManager) (*v1beta1.InstanceManager, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.InstanceManager, error)
	List(opts v1.ListOptions) (*v1beta1.InstanceManagerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.InstanceManager, err error)
...
func (c *instanceManagers) Get(name string, options v1.GetOptions) (result *v1beta1.InstanceManager, err error) {
...
func (c *instanceManagers) List(opts v1.ListOptions) (result *v1beta1.InstanceManagerList, err error) {
...
func (c *instanceManagers) Create(instanceManager *v1beta1.InstanceManager) (result *v1beta1.InstanceManager, err error) {
	result = &v1beta1.InstanceManager{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancemanagers").
...
func (c *instanceManagers) Update(instanceManager *v1beta1.InstanceManager) (result *v1beta1.InstanceManager, err error) {
	result = &v1beta1.InstanceManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancemanagers").
...
func (c *instanceManagers) UpdateStatus(instanceManager *v1beta1.InstanceManager) (result *v1beta1.InstanceManager, err error) {
	result = &v1beta1.InstanceManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancemanagers").
...
func (c *instanceManagers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.InstanceManager, err error) {
	result = &v1beta1.InstanceManager{}
