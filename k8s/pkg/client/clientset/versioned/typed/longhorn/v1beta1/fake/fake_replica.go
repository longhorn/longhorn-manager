...
func (c *FakeReplicas) Get(name string, options v1.GetOptions) (result *v1beta1.Replica, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicas) List(opts v1.ListOptions) (result *v1beta1.ReplicaList, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicas) Create(replica *v1beta1.Replica) (result *v1beta1.Replica, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicas) Update(replica *v1beta1.Replica) (result *v1beta1.Replica, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicas) UpdateStatus(replica *v1beta1.Replica) (*v1beta1.Replica, error) {
	obj, err := c.Fake.
...
func (c *FakeReplicas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Replica, err error) {
	obj, err := c.Fake.
