...
type BackupInterface interface {
	...
	Get(name string, options v1.GetOptions) (*v1beta1.Backup, error)
	List(opts v1.ListOptions) (*v1beta1.BackupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Backup, err error)
	BackupExpansion
}
...
func (c *backups) Get(name string, options v1.GetOptions) (result *v1beta1.Backup, err error) {
...
func (c *backups) List(opts v1.ListOptions) (result *v1beta1.BackupList, err error) {
...
func (c *backups) Create(backup *v1beta1.Backup) (result *v1beta1.Backup, err error) {
	result = &v1beta1.Backup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) Update(backup *v1beta1.Backup) (result *v1beta1.Backup, err error) {
	result = &v1beta1.Backup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) UpdateStatus(backup *v1beta1.Backup) (result *v1beta1.Backup, err error) {
	result = &v1beta1.Backup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backups").
...
func (c *backups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Backup, err error) {
	result = &v1beta1.Backup{}
