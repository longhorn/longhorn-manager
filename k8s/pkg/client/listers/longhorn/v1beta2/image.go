...
type ImageLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.Image, err error)
...
// List lists all Images in the indexer.
func (s *imageLister) List(selector labels.Selector) (ret []*v1beta2.Image, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.Image))
	})
	return ret, err
}
...
type ImageNamespaceLister interface {
	...
	Get(name string) (*v1beta2.Image, error)
...
// List lists all Images in the indexer for a given namespace.
func (s imageNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.Image, err error) {
...
// Get retrieves the Image from the indexer for a given namespace and name.
func (s imageNamespaceLister) Get(name string) (*v1beta2.Image, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("image"), name)
	}
	return obj.(*v1beta2.Image), nil
}
