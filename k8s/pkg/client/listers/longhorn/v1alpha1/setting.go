...
// List lists all Settings in the indexer for a given namespace.
func (s settingNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Setting, err error) {
...
// Get retrieves the Setting from the indexer for a given namespace and name.
func (s settingNamespaceLister) Get(name string) (*v1alpha1.Setting, error) {
