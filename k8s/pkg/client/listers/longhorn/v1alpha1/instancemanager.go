...
type InstanceManagerLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.InstanceManager, err error)
...
// List lists all InstanceManagers in the indexer.
func (s *instanceManagerLister) List(selector labels.Selector) (ret []*v1alpha1.InstanceManager, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.InstanceManager))
	})
	return ret, err
}
...
type InstanceManagerNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.InstanceManager, error)
...
// List lists all InstanceManagers in the indexer for a given namespace.
func (s instanceManagerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.InstanceManager, err error) {
...
// Get retrieves the InstanceManager from the indexer for a given namespace and name.
func (s instanceManagerNamespaceLister) Get(name string) (*v1alpha1.InstanceManager, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("instancemanager"), name)
	}
	return obj.(*v1alpha1.InstanceManager), nil
}
