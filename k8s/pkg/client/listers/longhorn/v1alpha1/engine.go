...
type EngineLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.Engine, err error)
...
// List lists all Engines in the indexer.
func (s *engineLister) List(selector labels.Selector) (ret []*v1alpha1.Engine, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Engine))
	})
	return ret, err
}
...
type EngineNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.Engine, error)
...
// List lists all Engines in the indexer for a given namespace.
func (s engineNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Engine, err error) {
...
// Get retrieves the Engine from the indexer for a given namespace and name.
func (s engineNamespaceLister) Get(name string) (*v1alpha1.Engine, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("engine"), name)
	}
	return obj.(*v1alpha1.Engine), nil
}
