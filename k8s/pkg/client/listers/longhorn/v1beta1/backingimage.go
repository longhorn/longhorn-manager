...
type BackingImageLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.BackingImage, err error)
...
type backingImageLister struct {
	listers.ResourceIndexer[*longhornv1beta1.BackingImage]
}
...
func NewBackingImageLister(indexer cache.Indexer) BackingImageLister {
	return &backingImageLister{listers.New[*longhornv1beta1.BackingImage](indexer, longhornv1beta1.Resource("backingimage"))}
}

// BackingImages returns an object that can list and get BackingImages.
func (s *backingImageLister) BackingImages(namespace string) BackingImageNamespaceLister {
	return backingImageNamespaceLister{listers.NewNamespaced[*longhornv1beta1.BackingImage](s.ResourceIndexer, namespace)}
}
...
type BackingImageNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.BackingImage, error)
