...
type SupportBundleLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.SupportBundle, err error)
...
// List lists all SupportBundles in the indexer.
func (s *supportBundleLister) List(selector labels.Selector) (ret []*v1beta1.SupportBundle, err error) {
...
type SupportBundleNamespaceLister interface {
	...
	Get(name string) (*v1beta1.SupportBundle, error)
...
// List lists all SupportBundles in the indexer for a given namespace.
func (s supportBundleNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.SupportBundle, err error) {
...
// Get retrieves the SupportBundle from the indexer for a given namespace and name.
func (s supportBundleNamespaceLister) Get(name string) (*v1beta1.SupportBundle, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("supportbundle"), name)
	}
