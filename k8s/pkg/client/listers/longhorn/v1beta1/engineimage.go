...
type EngineImageLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.EngineImage, err error)
...
type engineImageLister struct {
	listers.ResourceIndexer[*longhornv1beta1.EngineImage]
}

// NewEngineImageLister returns a new EngineImageLister.
func NewEngineImageLister(indexer cache.Indexer) EngineImageLister {
	return &engineImageLister{listers.New[*longhornv1beta1.EngineImage](indexer, longhornv1beta1.Resource("engineimage"))}
}

// EngineImages returns an object that can list and get EngineImages.
func (s *engineImageLister) EngineImages(namespace string) EngineImageNamespaceLister {
	return engineImageNamespaceLister{listers.NewNamespaced[*longhornv1beta1.EngineImage](s.ResourceIndexer, namespace)}
}
...
type EngineImageNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.EngineImage, error)
