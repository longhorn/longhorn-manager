...
type DiskLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Disk, err error)
...
// List lists all Disks in the indexer.
func (s *diskLister) List(selector labels.Selector) (ret []*v1beta1.Disk, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Disk))
	})
	return ret, err
}
...
type DiskNamespaceLister interface {
	...
	Get(name string) (*v1beta1.Disk, error)
...
// List lists all Disks in the indexer for a given namespace.
func (s diskNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Disk, err error) {
...
// Get retrieves the Disk from the indexer for a given namespace and name.
func (s diskNamespaceLister) Get(name string) (*v1beta1.Disk, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("disk"), name)
	}
	return obj.(*v1beta1.Disk), nil
}
