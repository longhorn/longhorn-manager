...
type ReplicaLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.Replica, err error)
...
type replicaLister struct {
	listers.ResourceIndexer[*longhornv1beta1.Replica]
}

// NewReplicaLister returns a new ReplicaLister.
func NewReplicaLister(indexer cache.Indexer) ReplicaLister {
	return &replicaLister{listers.New[*longhornv1beta1.Replica](indexer, longhornv1beta1.Resource("replica"))}
}

// Replicas returns an object that can list and get Replicas.
func (s *replicaLister) Replicas(namespace string) ReplicaNamespaceLister {
	return replicaNamespaceLister{listers.NewNamespaced[*longhornv1beta1.Replica](s.ResourceIndexer, namespace)}
}
...
type ReplicaNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.Replica, error)
