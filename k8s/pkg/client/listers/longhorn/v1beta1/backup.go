...
type BackupLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.Backup, err error)
...
type backupLister struct {
	listers.ResourceIndexer[*longhornv1beta1.Backup]
}

// NewBackupLister returns a new BackupLister.
func NewBackupLister(indexer cache.Indexer) BackupLister {
	return &backupLister{listers.New[*longhornv1beta1.Backup](indexer, longhornv1beta1.Resource("backup"))}
}

// Backups returns an object that can list and get Backups.
func (s *backupLister) Backups(namespace string) BackupNamespaceLister {
	return backupNamespaceLister{listers.NewNamespaced[*longhornv1beta1.Backup](s.ResourceIndexer, namespace)}
}
...
type BackupNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.Backup, error)
