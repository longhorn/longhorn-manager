...
type VolumeLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.Volume, err error)
...
type volumeLister struct {
	listers.ResourceIndexer[*longhornv1beta1.Volume]
}

// NewVolumeLister returns a new VolumeLister.
func NewVolumeLister(indexer cache.Indexer) VolumeLister {
	return &volumeLister{listers.New[*longhornv1beta1.Volume](indexer, longhornv1beta1.Resource("volume"))}
}

// Volumes returns an object that can list and get Volumes.
func (s *volumeLister) Volumes(namespace string) VolumeNamespaceLister {
	return volumeNamespaceLister{listers.NewNamespaced[*longhornv1beta1.Volume](s.ResourceIndexer, namespace)}
}
...
type VolumeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.Volume, error)
