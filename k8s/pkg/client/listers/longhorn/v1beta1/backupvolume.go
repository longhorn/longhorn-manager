...
type BackupVolumeLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.BackupVolume, err error)
...
type backupVolumeLister struct {
	listers.ResourceIndexer[*longhornv1beta1.BackupVolume]
}
...
func NewBackupVolumeLister(indexer cache.Indexer) BackupVolumeLister {
	return &backupVolumeLister{listers.New[*longhornv1beta1.BackupVolume](indexer, longhornv1beta1.Resource("backupvolume"))}
}

// BackupVolumes returns an object that can list and get BackupVolumes.
func (s *backupVolumeLister) BackupVolumes(namespace string) BackupVolumeNamespaceLister {
	return backupVolumeNamespaceLister{listers.NewNamespaced[*longhornv1beta1.BackupVolume](s.ResourceIndexer, namespace)}
}
...
type BackupVolumeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.BackupVolume, error)
