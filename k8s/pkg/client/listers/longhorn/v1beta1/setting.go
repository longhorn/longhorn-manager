...
type SettingLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.Setting, err error)
...
type settingLister struct {
	listers.ResourceIndexer[*longhornv1beta1.Setting]
}

// NewSettingLister returns a new SettingLister.
func NewSettingLister(indexer cache.Indexer) SettingLister {
	return &settingLister{listers.New[*longhornv1beta1.Setting](indexer, longhornv1beta1.Resource("setting"))}
}

// Settings returns an object that can list and get Settings.
func (s *settingLister) Settings(namespace string) SettingNamespaceLister {
	return settingNamespaceLister{listers.NewNamespaced[*longhornv1beta1.Setting](s.ResourceIndexer, namespace)}
}
...
type SettingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.Setting, error)
