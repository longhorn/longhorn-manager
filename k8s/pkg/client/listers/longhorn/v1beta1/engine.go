...
type EngineLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.Engine, err error)
...
type engineLister struct {
	listers.ResourceIndexer[*longhornv1beta1.Engine]
}

// NewEngineLister returns a new EngineLister.
func NewEngineLister(indexer cache.Indexer) EngineLister {
	return &engineLister{listers.New[*longhornv1beta1.Engine](indexer, longhornv1beta1.Resource("engine"))}
}

// Engines returns an object that can list and get Engines.
func (s *engineLister) Engines(namespace string) EngineNamespaceLister {
	return engineNamespaceLister{listers.NewNamespaced[*longhornv1beta1.Engine](s.ResourceIndexer, namespace)}
}
...
type EngineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.Engine, error)
