...
type BackingImageDataSourceLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.BackingImageDataSource, err error)
...
type backingImageDataSourceLister struct {
	listers.ResourceIndexer[*longhornv1beta1.BackingImageDataSource]
}
...
func NewBackingImageDataSourceLister(indexer cache.Indexer) BackingImageDataSourceLister {
	return &backingImageDataSourceLister{listers.New[*longhornv1beta1.BackingImageDataSource](indexer, longhornv1beta1.Resource("backingimagedatasource"))}
}

// BackingImageDataSources returns an object that can list and get BackingImageDataSources.
func (s *backingImageDataSourceLister) BackingImageDataSources(namespace string) BackingImageDataSourceNamespaceLister {
	return backingImageDataSourceNamespaceLister{listers.NewNamespaced[*longhornv1beta1.BackingImageDataSource](s.ResourceIndexer, namespace)}
}
...
type BackingImageDataSourceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.BackingImageDataSource, error)
