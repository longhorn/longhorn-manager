...
type BackupTargetLister interface {
	...
	List(selector labels.Selector) (ret []*longhornv1beta1.BackupTarget, err error)
...
type backupTargetLister struct {
	listers.ResourceIndexer[*longhornv1beta1.BackupTarget]
}
...
func NewBackupTargetLister(indexer cache.Indexer) BackupTargetLister {
	return &backupTargetLister{listers.New[*longhornv1beta1.BackupTarget](indexer, longhornv1beta1.Resource("backuptarget"))}
}

// BackupTargets returns an object that can list and get BackupTargets.
func (s *backupTargetLister) BackupTargets(namespace string) BackupTargetNamespaceLister {
	return backupTargetNamespaceLister{listers.NewNamespaced[*longhornv1beta1.BackupTarget](s.ResourceIndexer, namespace)}
}
...
type BackupTargetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*longhornv1beta1.BackupTarget, error)
