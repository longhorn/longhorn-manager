...
type VolumeSpec struct {
	...
	// +kubebuilder:validation:Enum=ignored;disabled;enabled
	// Controls whether Longhorn should rebuild replicas while the volume is offline.
	...
	// - disable: Disable offline rebuilding for this volume, regardless of the global setting
	// +optional
