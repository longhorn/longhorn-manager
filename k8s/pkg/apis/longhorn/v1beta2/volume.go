...
type VolumeSpec struct {
	...
	// ReplicaRebuildBandwidthLimit limits the write bandwidth (in megabytes per second) on the destination replica during rebuilding. Set to 0 to disable bandwidth limiting.
	// +kubebuilder:validation:Minimum=0
	// +optional
	ReplicaRebuildBandwidthLimit int64 `json:"replicaRebuildBandwidthLimit,omitempty"`
}
