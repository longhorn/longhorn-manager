...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskSchedule) DeepCopyInto(out *DiskSchedule) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskSchedule.
func (in *DiskSchedule) DeepCopy() *DiskSchedule {
	if in == nil {
		return nil
	}
	out := new(DiskSchedule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *DiskSchedule) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskScheduleList) DeepCopyInto(out *DiskScheduleList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]DiskSchedule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskScheduleList.
func (in *DiskScheduleList) DeepCopy() *DiskScheduleList {
	if in == nil {
		return nil
	}
	out := new(DiskScheduleList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *DiskScheduleList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskScheduleSpec) DeepCopyInto(out *DiskScheduleSpec) {
	*out = *in
	if in.SchedulingReplicas != nil {
		in, out := &in.SchedulingReplicas, &out.SchedulingReplicas
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.SchedulingBackingImages != nil {
		in, out := &in.SchedulingBackingImages, &out.SchedulingBackingImages
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskScheduleSpec.
func (in *DiskScheduleSpec) DeepCopy() *DiskScheduleSpec {
	if in == nil {
		return nil
	}
	out := new(DiskScheduleSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskScheduleStatus) DeepCopyInto(out *DiskScheduleStatus) {
	*out = *in
	if in.ScheduledReplicaStatus != nil {
		in, out := &in.ScheduledReplicaStatus, &out.ScheduledReplicaStatus
		*out = make(map[string]*DiskScheduledResourcesStatus, len(*in))
		for key, val := range *in {
			var outVal *DiskScheduledResourcesStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(DiskScheduledResourcesStatus)
				**out = **in
			}
			(*out)[key] = outVal
		}
	}
	if in.ScheduledBackingImageStatus != nil {
		in, out := &in.ScheduledBackingImageStatus, &out.ScheduledBackingImageStatus
		*out = make(map[string]*DiskScheduledResourcesStatus, len(*in))
		for key, val := range *in {
			var outVal *DiskScheduledResourcesStatus
			if val == nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskScheduleStatus.
func (in *DiskScheduleStatus) DeepCopy() *DiskScheduleStatus {
	if in == nil {
		return nil
	}
	out := new(DiskScheduleStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskScheduledResourcesStatus) DeepCopyInto(out *DiskScheduledResourcesStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskScheduledResourcesStatus.
func (in *DiskScheduledResourcesStatus) DeepCopy() *DiskScheduledResourcesStatus {
	if in == nil {
		return nil
	}
	out := new(DiskScheduledResourcesStatus)
