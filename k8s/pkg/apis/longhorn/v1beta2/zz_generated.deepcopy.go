...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicaRebuildStatus) DeepCopyInto(out *ReplicaRebuildStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicaRebuildStatus.
func (in *ReplicaRebuildStatus) DeepCopy() *ReplicaRebuildStatus {
	if in == nil {
		return nil
	}
	out := new(ReplicaRebuildStatus)
	in.DeepCopyInto(out)
	return out
}
