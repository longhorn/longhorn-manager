...
func (in *InstanceManagerUpgradeStatus) DeepCopyInto(out *InstanceManagerUpgradeStatus) {
	*out = *in
	...
	if in.PlannedDetachedReplicas != nil {
		in, out := &in.PlannedDetachedReplicas, &out.PlannedDetachedReplicas
		*out = make(map[string][]PlannedDetachedReplica, len(*in))
		for key, val := range *in {
			var outVal []PlannedDetachedReplica
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]PlannedDetachedReplica, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlannedDetachedReplica) DeepCopyInto(out *PlannedDetachedReplica) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlannedDetachedReplica.
func (in *PlannedDetachedReplica) DeepCopy() *PlannedDetachedReplica {
	if in == nil {
		return nil
	}
	out := new(PlannedDetachedReplica)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeAntiAffinity) DeepCopyInto(out *VolumeAntiAffinity) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeAntiAffinity.
func (in *VolumeAntiAffinity) DeepCopy() *VolumeAntiAffinity {
	if in == nil {
		return nil
	}
	out := new(VolumeAntiAffinity)
	in.DeepCopyInto(out)
	return out
}
