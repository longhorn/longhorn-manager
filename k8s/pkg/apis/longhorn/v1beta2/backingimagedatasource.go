...
// +kubebuilder:validation:Enum=download;upload;export-from-volume;download-from-backup-target
type BackingImageDataSourceType string

const (
	BackingImageDataSourceTypeDownload                 = BackingImageDataSourceType("download")
	BackingImageDataSourceTypeDownloadFromBackupTarget = BackingImageDataSourceType("download-from-backup-target")
