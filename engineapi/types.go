...
type EngineClient interface {
	...
	ReplicaAdd(engine *longhorn.Engine, replicaName, url string, isRestoreVolume, fastSync bool, replicaFileSyncHTTPClientTimeout int64, localSync *etypes.FileLocalSync) error
