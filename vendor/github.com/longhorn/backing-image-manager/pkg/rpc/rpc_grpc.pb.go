...
func (c *backingImageManagerServiceClient) Backup(ctx context.Context, in *BackupRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/longhorn.backingimagemanager.pkg.rpc.BackingImageManagerService/Backup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backingImageManagerServiceClient) Watch(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (BackingImageManagerService_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &BackingImageManagerService_ServiceDesc.Streams[0], "/longhorn.backingimagemanager.pkg.rpc.BackingImageManagerService/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedBackingImageManagerServiceServer) Backup(context.Context, *BackupRequest) (*empty.Empty, error) {
...
func _BackingImageManagerService_Backup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackingImageManagerServiceServer).Backup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/longhorn.backingimagemanager.pkg.rpc.BackingImageManagerService/Backup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackingImageManagerServiceServer).Backup(ctx, req.(*BackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackingImageManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Backup",
			Handler:    _BackingImageManagerService_Backup_Handler,
		},
	},
