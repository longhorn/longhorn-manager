...
var file_spdkrpc_spdk_proto_rawDesc = []byte{
	...
	0x52, 0x52, 0x10, 0x02, 0x32, 0x91, 0x23, 0x0a, 0x0b, 0x53, 0x50, 0x44, 0x4b, 0x53, 0x65, 0x72,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x93, 0x01, 0x0a, 0x24, 0x52,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x65, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e, 0x67,
	...
	0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x35, 0x2e, 0x73, 0x70, 0x64, 0x6b,
	...
	0x6f, 0x70, 0x79, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x75, 0x0a, 0x22, 0x52, 0x65, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x52, 0x65, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x73, 0x74,
	...
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x33, 0x2e, 0x73, 0x70, 0x64, 0x6b, 0x72,
	0x70, 0x63, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x65, 0x62, 0x75, 0x69, 0x6c,
	0x64, 0x69, 0x6e, 0x67, 0x44, 0x73, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52,
	...
	0x70, 0x64, 0x6b, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x42, 0x61, 0x63,
	0x6b, 0x75, 0x70, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x56, 0x0a, 0x13, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x52, 0x65,
...
var file_spdkrpc_spdk_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_spdkrpc_spdk_proto_goTypes = []interface{}{
	...
	nil,                                        // 61: spdkrpc.Lvol.ChildrenEntry
	nil,                                        // 62: spdkrpc.Replica.SnapshotsEntry
	nil,                                        // 63: spdkrpc.ReplicaListResponse.ReplicasEntry
	nil,                                        // 64: spdkrpc.Engine.ReplicaAddressMapEntry
	nil,                                        // 65: spdkrpc.Engine.ReplicaModeMapEntry
	nil,                                        // 66: spdkrpc.Engine.SnapshotsEntry
	nil,                                        // 67: spdkrpc.EngineCreateRequest.ReplicaAddressMapEntry
	nil,                                        // 68: spdkrpc.EngineListResponse.EnginesEntry
	nil,                                        // 69: spdkrpc.EngineReplicaListResponse.ReplicasEntry
	nil,                                        // 70: spdkrpc.BackupCreateRequest.CredentialEntry
	nil,                                        // 71: spdkrpc.EngineBackupRestoreRequest.CredentialEntry
	nil,                                        // 72: spdkrpc.EngineBackupRestoreResponse.ErrorsEntry
	nil,                                        // 73: spdkrpc.ReplicaBackupRestoreRequest.CredentialEntry
	nil,                                        // 74: spdkrpc.RestoreStatusResponse.StatusEntry
	(*emptypb.Empty)(nil),                      // 75: google.protobuf.Empty
}
var file_spdkrpc_spdk_proto_depIdxs = []int32{
	61, // 0: spdkrpc.Lvol.children:type_name -> spdkrpc.Lvol.ChildrenEntry
	1,  // 1: spdkrpc.Replica.head:type_name -> spdkrpc.Lvol
	62, // 2: spdkrpc.Replica.snapshots:type_name -> spdkrpc.Replica.SnapshotsEntry
	63, // 3: spdkrpc.ReplicaListResponse.replicas:type_name -> spdkrpc.ReplicaListResponse.ReplicasEntry
	1,  // 4: spdkrpc.ReplicaRebuildingDstStartRequest.rebuilding_snapshot_list:type_name -> spdkrpc.Lvol
	64, // 5: spdkrpc.Engine.replica_address_map:type_name -> spdkrpc.Engine.ReplicaAddressMapEntry
	65, // 6: spdkrpc.Engine.replica_mode_map:type_name -> spdkrpc.Engine.ReplicaModeMapEntry
	1,  // 7: spdkrpc.Engine.head:type_name -> spdkrpc.Lvol
	66, // 8: spdkrpc.Engine.snapshots:type_name -> spdkrpc.Engine.SnapshotsEntry
	67, // 9: spdkrpc.EngineCreateRequest.replica_address_map:type_name -> spdkrpc.EngineCreateRequest.ReplicaAddressMapEntry
	68, // 10: spdkrpc.EngineListResponse.engines:type_name -> spdkrpc.EngineListResponse.EnginesEntry
	69, // 11: spdkrpc.EngineReplicaListResponse.replicas:type_name -> spdkrpc.EngineReplicaListResponse.ReplicasEntry
	40, // 12: spdkrpc.VersionDetailGetReply.version:type_name -> spdkrpc.VersionOutput
	70, // 13: spdkrpc.BackupCreateRequest.credential:type_name -> spdkrpc.BackupCreateRequest.CredentialEntry
	71, // 14: spdkrpc.EngineBackupRestoreRequest.credential:type_name -> spdkrpc.EngineBackupRestoreRequest.CredentialEntry
	72, // 15: spdkrpc.EngineBackupRestoreResponse.errors:type_name -> spdkrpc.EngineBackupRestoreResponse.ErrorsEntry
	73, // 16: spdkrpc.ReplicaBackupRestoreRequest.credential:type_name -> spdkrpc.ReplicaBackupRestoreRequest.CredentialEntry
	74, // 17: spdkrpc.RestoreStatusResponse.status:type_name -> spdkrpc.RestoreStatusResponse.StatusEntry
	...
	75, // 32: spdkrpc.SPDKService.ReplicaList:input_type -> google.protobuf.Empty
	75, // 33: spdkrpc.SPDKService.ReplicaWatch:input_type -> google.protobuf.Empty
	...
	75, // 61: spdkrpc.SPDKService.EngineList:input_type -> google.protobuf.Empty
	75, // 62: spdkrpc.SPDKService.EngineWatch:input_type -> google.protobuf.Empty
	...
	49, // 69: spdkrpc.SPDKService.EngineRestoreStatus:input_type -> spdkrpc.RestoreStatusRequest
	54, // 70: spdkrpc.SPDKService.DiskCreate:input_type -> spdkrpc.DiskCreateRequest
	56, // 71: spdkrpc.SPDKService.DiskDelete:input_type -> spdkrpc.DiskDeleteRequest
	55, // 72: spdkrpc.SPDKService.DiskGet:input_type -> spdkrpc.DiskGetRequest
	57, // 73: spdkrpc.SPDKService.LogSetLevel:input_type -> spdkrpc.LogSetLevelRequest
	58, // 74: spdkrpc.SPDKService.LogSetFlags:input_type -> spdkrpc.LogSetFlagsRequest
	75, // 75: spdkrpc.SPDKService.LogGetLevel:input_type -> google.protobuf.Empty
	75, // 76: spdkrpc.SPDKService.LogGetFlags:input_type -> google.protobuf.Empty
	75, // 77: spdkrpc.SPDKService.VersionDetailGet:input_type -> google.protobuf.Empty
	2,  // 78: spdkrpc.SPDKService.ReplicaCreate:output_type -> spdkrpc.Replica
	75, // 79: spdkrpc.SPDKService.ReplicaDelete:output_type -> google.protobuf.Empty
	2,  // 80: spdkrpc.SPDKService.ReplicaGet:output_type -> spdkrpc.Replica
	2,  // 81: spdkrpc.SPDKService.ReplicaSnapshotCreate:output_type -> spdkrpc.Replica
	75, // 82: spdkrpc.SPDKService.ReplicaSnapshotDelete:output_type -> google.protobuf.Empty
	75, // 83: spdkrpc.SPDKService.ReplicaSnapshotRevert:output_type -> google.protobuf.Empty
	75, // 84: spdkrpc.SPDKService.ReplicaSnapshotPurge:output_type -> google.protobuf.Empty
	6,  // 85: spdkrpc.SPDKService.ReplicaList:output_type -> spdkrpc.ReplicaListResponse
	75, // 86: spdkrpc.SPDKService.ReplicaWatch:output_type -> google.protobuf.Empty
	8,  // 87: spdkrpc.SPDKService.ReplicaRebuildingSrcStart:output_type -> spdkrpc.ReplicaRebuildingSrcStartResponse
	75, // 88: spdkrpc.SPDKService.ReplicaRebuildingSrcFinish:output_type -> google.protobuf.Empty
	75, // 89: spdkrpc.SPDKService.ReplicaRebuildingSrcAttach:output_type -> google.protobuf.Empty
	75, // 90: spdkrpc.SPDKService.ReplicaRebuildingSrcDetach:output_type -> google.protobuf.Empty
	13, // 91: spdkrpc.SPDKService.ReplicaRebuildingSrcShallowCopyStart:output_type -> spdkrpc.ReplicaRebuildingSrcShallowCopyStartResponse
	15, // 92: spdkrpc.SPDKService.ReplicaRebuildingSrcShallowCopyCheck:output_type -> spdkrpc.ReplicaRebuildingSrcShallowCopyCheckResponse
	17, // 93: spdkrpc.SPDKService.ReplicaRebuildingDstStart:output_type -> spdkrpc.ReplicaRebuildingDstStartResponse
	75, // 94: spdkrpc.SPDKService.ReplicaRebuildingDstFinish:output_type -> google.protobuf.Empty
	75, // 95: spdkrpc.SPDKService.ReplicaRebuildingDstShallowCopyStart:output_type -> google.protobuf.Empty
	21, // 96: spdkrpc.SPDKService.ReplicaRebuildingDstShallowCopyCheck:output_type -> spdkrpc.ReplicaRebuildingDstShallowCopyCheckResponse
	75, // 97: spdkrpc.SPDKService.ReplicaRebuildingDstSnapshotCreate:output_type -> google.protobuf.Empty
	22, // 98: spdkrpc.SPDKService.ReplicaRebuildingDstSnapshotRevert:output_type -> spdkrpc.ReplicaRebuildingDstSnapshotRevertResponse
	43, // 99: spdkrpc.SPDKService.ReplicaBackupCreate:output_type -> spdkrpc.BackupCreateResponse
	45, // 100: spdkrpc.SPDKService.ReplicaBackupStatus:output_type -> spdkrpc.BackupStatusResponse
	75, // 101: spdkrpc.SPDKService.ReplicaBackupRestore:output_type -> google.protobuf.Empty
	51, // 102: spdkrpc.SPDKService.ReplicaRestoreStatus:output_type -> spdkrpc.ReplicaRestoreStatusResponse
	23, // 103: spdkrpc.SPDKService.EngineCreate:output_type -> spdkrpc.Engine
	75, // 104: spdkrpc.SPDKService.EngineDelete:output_type -> google.protobuf.Empty
	23, // 105: spdkrpc.SPDKService.EngineGet:output_type -> spdkrpc.Engine
	75, // 106: spdkrpc.SPDKService.EngineSuspend:output_type -> google.protobuf.Empty
	75, // 107: spdkrpc.SPDKService.EngineResume:output_type -> google.protobuf.Empty
	75, // 108: spdkrpc.SPDKService.EngineSwitchOverTarget:output_type -> google.protobuf.Empty
	75, // 109: spdkrpc.SPDKService.EngineDeleteTarget:output_type -> google.protobuf.Empty
	39, // 110: spdkrpc.SPDKService.EngineSnapshotCreate:output_type -> spdkrpc.SnapshotResponse
	75, // 111: spdkrpc.SPDKService.EngineSnapshotDelete:output_type -> google.protobuf.Empty
	75, // 112: spdkrpc.SPDKService.EngineSnapshotRevert:output_type -> google.protobuf.Empty
	75, // 113: spdkrpc.SPDKService.EngineSnapshotPurge:output_type -> google.protobuf.Empty
	31, // 114: spdkrpc.SPDKService.EngineList:output_type -> spdkrpc.EngineListResponse
	75, // 115: spdkrpc.SPDKService.EngineWatch:output_type -> google.protobuf.Empty
	34, // 116: spdkrpc.SPDKService.EngineReplicaList:output_type -> spdkrpc.EngineReplicaListResponse
	75, // 117: spdkrpc.SPDKService.EngineReplicaAdd:output_type -> google.protobuf.Empty
	75, // 118: spdkrpc.SPDKService.EngineReplicaDelete:output_type -> google.protobuf.Empty
	43, // 119: spdkrpc.SPDKService.EngineBackupCreate:output_type -> spdkrpc.BackupCreateResponse
	45, // 120: spdkrpc.SPDKService.EngineBackupStatus:output_type -> spdkrpc.BackupStatusResponse
	47, // 121: spdkrpc.SPDKService.EngineBackupRestore:output_type -> spdkrpc.EngineBackupRestoreResponse
	52, // 122: spdkrpc.SPDKService.EngineRestoreStatus:output_type -> spdkrpc.RestoreStatusResponse
	53, // 123: spdkrpc.SPDKService.DiskCreate:output_type -> spdkrpc.Disk
	75, // 124: spdkrpc.SPDKService.DiskDelete:output_type -> google.protobuf.Empty
	53, // 125: spdkrpc.SPDKService.DiskGet:output_type -> spdkrpc.Disk
	75, // 126: spdkrpc.SPDKService.LogSetLevel:output_type -> google.protobuf.Empty
	75, // 127: spdkrpc.SPDKService.LogSetFlags:output_type -> google.protobuf.Empty
	59, // 128: spdkrpc.SPDKService.LogGetLevel:output_type -> spdkrpc.LogGetLevelResponse
	60, // 129: spdkrpc.SPDKService.LogGetFlags:output_type -> spdkrpc.LogGetFlagsResponse
	41, // 130: spdkrpc.SPDKService.VersionDetailGet:output_type -> spdkrpc.VersionDetailGetReply
