...
var file_spdkrpc_spdk_proto_rawDesc = []byte{
	...
	0x57, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x45, 0x52, 0x52, 0x10, 0x02, 0x32, 0x84, 0x26, 0x0a,
	...
	0x65, 0x12, 0x46, 0x0a, 0x0d, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x53, 0x75, 0x73, 0x70, 0x65,
	0x6e, 0x64, 0x12, 0x1d, 0x2e, 0x73, 0x70, 0x64, 0x6b, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x6e, 0x67,
	...
	,
...
var file_spdkrpc_spdk_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_spdkrpc_spdk_proto_goTypes = []interface{}{
	...
	nil,                                                  // 66: spdkrpc.Lvol.ChildrenEntry
	nil,                                                  // 67: spdkrpc.Replica.SnapshotsEntry
	nil,                                                  // 68: spdkrpc.ReplicaListResponse.ReplicasEntry
	nil,                                                  // 69: spdkrpc.Engine.ReplicaAddressMapEntry
	nil,                                                  // 70: spdkrpc.Engine.ReplicaModeMapEntry
	nil,                                                  // 71: spdkrpc.Engine.SnapshotsEntry
	nil,                                                  // 72: spdkrpc.EngineCreateRequest.ReplicaAddressMapEntry
	nil,                                                  // 73: spdkrpc.EngineListResponse.EnginesEntry
	nil,                                                  // 74: spdkrpc.EngineReplicaListResponse.ReplicasEntry
	nil,                                                  // 75: spdkrpc.BackupCreateRequest.CredentialEntry
	nil,                                                  // 76: spdkrpc.EngineBackupRestoreRequest.CredentialEntry
	nil,                                                  // 77: spdkrpc.EngineBackupRestoreResponse.ErrorsEntry
	nil,                                                  // 78: spdkrpc.ReplicaBackupRestoreRequest.CredentialEntry
	nil,                                                  // 79: spdkrpc.RestoreStatusResponse.StatusEntry
	nil,                                                  // 80: spdkrpc.BackingImageListResponse.BackingImagesEntry
	(*emptypb.Empty)(nil),                                // 81: google.protobuf.Empty
}
var file_spdkrpc_spdk_proto_depIdxs = []int32{
	66, // 0: spdkrpc.Lvol.children:type_name -> spdkrpc.Lvol.ChildrenEntry
	1,  // 1: spdkrpc.Replica.head:type_name -> spdkrpc.Lvol
	67, // 2: spdkrpc.Replica.snapshots:type_name -> spdkrpc.Replica.SnapshotsEntry
	68, // 3: spdkrpc.ReplicaListResponse.replicas:type_name -> spdkrpc.ReplicaListResponse.ReplicasEntry
	1,  // 4: spdkrpc.ReplicaRebuildingDstStartRequest.rebuilding_snapshot_list:type_name -> spdkrpc.Lvol
	69, // 5: spdkrpc.Engine.replica_address_map:type_name -> spdkrpc.Engine.ReplicaAddressMapEntry
	70, // 6: spdkrpc.Engine.replica_mode_map:type_name -> spdkrpc.Engine.ReplicaModeMapEntry
	1,  // 7: spdkrpc.Engine.head:type_name -> spdkrpc.Lvol
	71, // 8: spdkrpc.Engine.snapshots:type_name -> spdkrpc.Engine.SnapshotsEntry
	72, // 9: spdkrpc.EngineCreateRequest.replica_address_map:type_name -> spdkrpc.EngineCreateRequest.ReplicaAddressMapEntry
	73, // 10: spdkrpc.EngineListResponse.engines:type_name -> spdkrpc.EngineListResponse.EnginesEntry
	74, // 11: spdkrpc.EngineReplicaListResponse.replicas:type_name -> spdkrpc.EngineReplicaListResponse.ReplicasEntry
	36, // 12: spdkrpc.VersionDetailGetReply.version:type_name -> spdkrpc.VersionOutput
	75, // 13: spdkrpc.BackupCreateRequest.credential:type_name -> spdkrpc.BackupCreateRequest.CredentialEntry
	76, // 14: spdkrpc.EngineBackupRestoreRequest.credential:type_name -> spdkrpc.EngineBackupRestoreRequest.CredentialEntry
	77, // 15: spdkrpc.EngineBackupRestoreResponse.errors:type_name -> spdkrpc.EngineBackupRestoreResponse.ErrorsEntry
	78, // 16: spdkrpc.ReplicaBackupRestoreRequest.credential:type_name -> spdkrpc.ReplicaBackupRestoreRequest.CredentialEntry
	79, // 17: spdkrpc.RestoreStatusResponse.status:type_name -> spdkrpc.RestoreStatusResponse.StatusEntry
	1,  // 18: spdkrpc.BackingImage.snapshot:type_name -> spdkrpc.Lvol
	80, // 19: spdkrpc.BackingImageListResponse.backing_images:type_name -> spdkrpc.BackingImageListResponse.BackingImagesEntry
	...
	81, // 35: spdkrpc.SPDKService.ReplicaList:input_type -> google.protobuf.Empty
	81, // 36: spdkrpc.SPDKService.ReplicaWatch:input_type -> google.protobuf.Empty
	...
	81, // 61: spdkrpc.SPDKService.EngineList:input_type -> google.protobuf.Empty
	81, // 62: spdkrpc.SPDKService.EngineWatch:input_type -> google.protobuf.Empty
	...
	81, // 74: spdkrpc.SPDKService.BackingImageList:input_type -> google.protobuf.Empty
	81, // 75: spdkrpc.SPDKService.BackingImageWatch:input_type -> google.protobuf.Empty
	...
	81, // 83: spdkrpc.SPDKService.LogGetLevel:input_type -> google.protobuf.Empty
	81, // 84: spdkrpc.SPDKService.LogGetFlags:input_type -> google.protobuf.Empty
	81, // 85: spdkrpc.SPDKService.VersionDetailGet:input_type -> google.protobuf.Empty
	64, // 86: spdkrpc.SPDKService.MetricsGet:input_type -> spdkrpc.MetricsRequest
	2,  // 87: spdkrpc.SPDKService.ReplicaCreate:output_type -> spdkrpc.Replica
	81, // 88: spdkrpc.SPDKService.ReplicaDelete:output_type -> google.protobuf.Empty
	...
	81, // 91: spdkrpc.SPDKService.ReplicaSnapshotDelete:output_type -> google.protobuf.Empty
	81, // 92: spdkrpc.SPDKService.ReplicaSnapshotRevert:output_type -> google.protobuf.Empty
	81, // 93: spdkrpc.SPDKService.ReplicaSnapshotPurge:output_type -> google.protobuf.Empty
	6,  // 94: spdkrpc.SPDKService.ReplicaList:output_type -> spdkrpc.ReplicaListResponse
	81, // 95: spdkrpc.SPDKService.ReplicaWatch:output_type -> google.protobuf.Empty
	8,  // 96: spdkrpc.SPDKService.ReplicaRebuildingSrcStart:output_type -> spdkrpc.ReplicaRebuildingSrcStartResponse
	81, // 97: spdkrpc.SPDKService.ReplicaRebuildingSrcFinish:output_type -> google.protobuf.Empty
	81, // 98: spdkrpc.SPDKService.ReplicaRebuildingSrcShallowCopyStart:output_type -> google.protobuf.Empty
	...
	81, // 101: spdkrpc.SPDKService.ReplicaRebuildingDstFinish:output_type -> google.protobuf.Empty
	81, // 102: spdkrpc.SPDKService.ReplicaRebuildingDstShallowCopyStart:output_type -> google.protobuf.Empty
	...
	81, // 104: spdkrpc.SPDKService.ReplicaRebuildingDstSnapshotCreate:output_type -> google.protobuf.Empty
	...
	81, // 107: spdkrpc.SPDKService.ReplicaBackupRestore:output_type -> google.protobuf.Empty
	...
	81, // 110: spdkrpc.SPDKService.EngineDelete:output_type -> google.protobuf.Empty
	19, // 111: spdkrpc.SPDKService.EngineGet:output_type -> spdkrpc.Engine
	81, // 112: spdkrpc.SPDKService.EngineSuspend:output_type -> google.protobuf.Empty
	81, // 113: spdkrpc.SPDKService.EngineResume:output_type -> google.protobuf.Empty
	81, // 114: spdkrpc.SPDKService.EngineSwitchOverTarget:output_type -> google.protobuf.Empty
	81, // 115: spdkrpc.SPDKService.EngineDeleteTarget:output_type -> google.protobuf.Empty
	35, // 116: spdkrpc.SPDKService.EngineSnapshotCreate:output_type -> spdkrpc.SnapshotResponse
	81, // 117: spdkrpc.SPDKService.EngineSnapshotDelete:output_type -> google.protobuf.Empty
	81, // 118: spdkrpc.SPDKService.EngineSnapshotRevert:output_type -> google.protobuf.Empty
	81, // 119: spdkrpc.SPDKService.EngineSnapshotPurge:output_type -> google.protobuf.Empty
	27, // 120: spdkrpc.SPDKService.EngineList:output_type -> spdkrpc.EngineListResponse
	81, // 121: spdkrpc.SPDKService.EngineWatch:output_type -> google.protobuf.Empty
	30, // 122: spdkrpc.SPDKService.EngineReplicaList:output_type -> spdkrpc.EngineReplicaListResponse
	81, // 123: spdkrpc.SPDKService.EngineReplicaAdd:output_type -> google.protobuf.Empty
	81, // 124: spdkrpc.SPDKService.EngineReplicaDelete:output_type -> google.protobuf.Empty
	...
	81, // 128: spdkrpc.SPDKService.EngineBackupRestoreFinish:output_type -> google.protobuf.Empty
	...
	81, // 131: spdkrpc.SPDKService.BackingImageDelete:output_type -> google.protobuf.Empty
	...
	81, // 134: spdkrpc.SPDKService.BackingImageWatch:output_type -> google.protobuf.Empty
	55, // 135: spdkrpc.SPDKService.BackingImageExpose:output_type -> spdkrpc.BackingImageExposeResponse
	81, // 136: spdkrpc.SPDKService.BackingImageUnexpose:output_type -> google.protobuf.Empty
	56, // 137: spdkrpc.SPDKService.DiskCreate:output_type -> spdkrpc.Disk
	81, // 138: spdkrpc.SPDKService.DiskDelete:output_type -> google.protobuf.Empty
	56, // 139: spdkrpc.SPDKService.DiskGet:output_type -> spdkrpc.Disk
	81, // 140: spdkrpc.SPDKService.LogSetLevel:output_type -> google.protobuf.Empty
	81, // 141: spdkrpc.SPDKService.LogSetFlags:output_type -> google.protobuf.Empty
	...
	65, // 145: spdkrpc.SPDKService.MetricsGet:output_type -> spdkrpc.Metrics
