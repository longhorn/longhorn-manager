...
<<<<<<< HEAD:vendor/k8s.io/client-go/applyconfigurations/resource/v1alpha3/resourceslice.go
...
=======
>>>>>>> 6201979e (chore(crd): regenerate codes):k8s/pkg/client/applyconfiguration/longhorn/v1beta2/systemrestore.go
