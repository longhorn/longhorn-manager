...
// UpdatePDB updates a PodDisruptionBudget in the Longhorn namespace.
func (s *DataStore) UpdatePDB(obj *policyv1.PodDisruptionBudget) (*policyv1.PodDisruptionBudget, error) {
	return s.kubeClient.PolicyV1().PodDisruptionBudgets(s.namespace).Update(context.TODO(), obj, metav1.UpdateOptions{})
}
