...
// GetLonghornEventList returns an uncached list of longhorn events for the given
// namespace directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllPodsList returns an uncached list of pods for the given namespace directly
// from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllServicesList returns an uncached list of services for the given namespace
...
// GetAllDeploymentsList returns an uncached list of deployments for the given namespace
// directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllDaemonSetsList returns an uncached list of daemonsets for the given namespace
// directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllJobsList returns an uncached list of jobs for the given namespace directly
// from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllCronJobsList returns an uncached list of cronjobs for the given namespace
// directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllNodesList returns an uncached list of nodes for the given namespace directly
// from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetLonghornNamespace returns an uncached namespace object for the given namespace
// name directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllConfigMaps returns an uncached list of configmaps for the given namespace
// directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
...
// GetAllVolumeAttachments returns an uncached list of volumeattachments for the given
// namespace directly from the API server.
// Using cached informers should be preferred but current lister doesn't field selector.
// Direct retrieval from the API server should only be used for one-shot tasks. For
// example, support bundle creation
