...
func RetryOnNotFoundCause(fn func() (interface{}, error)) (obj interface{}, err error) {
	return RetryOnErrorCondition(fn, apierrors.IsNotFound)
}

func RetryOnErrorCondition(fn func() (interface{}, error), predicate func(error) bool) (obj interface{}, err error) {
	...
	return nil, errors.Wrapf(err, "cannot finish API request due to too many error retries")
}
